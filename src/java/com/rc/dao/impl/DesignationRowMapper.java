 ...
 * @author Admin
 */
public class DesignationRowMapper implements RowMapper<CommonDetail> {

     @Override
    public CommonDetail mapRow(ResultSet rs, int i) throws SQLException {
    CommonDetail commonDetail = new CommonDetail(); 
    
    commonDetail.setId(rs.getInt("designation_id"));
    commonDetail.setName(rs.getString("designation_name"));
